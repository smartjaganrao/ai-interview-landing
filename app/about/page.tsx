          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="glass-heavy rounded-3xl p-8 border border-white/10">
              <div className="text-center mb-8">
                ...
                <div className="text-2xl font-black text-[#1A1512] mb-2">2,400+</div>
                <div className="text-[#57534E]">Candidates helped across India</div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-4 rounded-xl bg-[rgba(26,21,18,0.04)]">
                  <div className="text-2xl font-black text-[#4F46E5]">15×</div>
                  <div className="text-xs text-[#57534E] mt-1">Cheaper than FR AI</div>
                </div>
                <div className="text-center p-4 rounded-xl bg-[rgba(26,21,18,0.04)]">
                  <div className="text-2xl font-black text-[#15803D]">&lt;2s</div>
                  <div className="text-xs text-[#57534E] mt-1">Answer speed</div>
                </div>
                <div className="text-center p-4 rounded-xl bg-[rgba(26,21,18,0.04)]">
                  <div className="text-2xl font-black text-[#8B2BE2]">10+</div>
                  <div className="text-xs text-[#57534E] mt-1">Indian languages</div>
                </div>
                <div className="text-center p-4 rounded-xl bg-[rgba(26,21,18,0.04)]">
                  <div className="text-2xl font-black text-[#BE185D]">Free</div>
                  <div className="text-xs text-[#57534E] mt-1">Forever plan</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="card text-center">
                ...
                <h3 className="text-xl font-bold text-[#1A1512] mb-3">Privacy First</h3>
              ...
              <div className="card text-center">
                <div className="text-4xl mb-4">🇮🇳</div>
                <h3 className="text-xl font-bold text-[#1A1512] mb-3">Made for India</h3>
                <p className="text-[#57534E] text-sm leading-relaxed">
              ...
              <div className="card text-center">
                <div className="text-4xl mb-4">⚡</div>
                <h3 className="text-xl font-bold text-[#1A1512] mb-3">Lightning Fast</h3>
                <p className="text-[#57534E] text-sm leading-relaxed">
          ...
          <div className="glass-heavy rounded-3xl p-8 md:p-12 border border-white/10 mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <div className="font-bold text-[#1A1512] text-lg">Jagan Rao</div>
                <div className="text-[#4F46E5] text-sm mb-2">Founder & CEO</div>
                <p className="text-[#57534E] text-xs leading-relaxed">Ex-IITian. Built interview tools used by 2,400+ candidates. Passionate about making interview success accessible.</p>
              </div>
              <div className="text-center">
                ...
                <div className="font-bold text-[#1A1512] text-lg">Priya Sharma</div>
                <div className="text-[#2563EB] text-sm mb-2">Head of AI</div>
                <p className="text-[#57534E] text-xs leading-relaxed">ML engineer from IISc Bangalore. Specializes in real-time speech processing and low-latency inference.</p>
              </div>
              <div className="text-center">
                ...
                <div className="font-bold text-[#1A1512] text-lg">Rahul Verma</div>
                <div className="text-[#C2410C] text-sm mb-2">Head of Product</div>
                <p className="text-[#57534E] text-xs leading-relaxed">Former product manager at Flipkart. Deep understanding of Indian job market and candidate pain points.</p>
              </div>
            </div>
          </div>
