...
const DIRECT_DOWNLOAD_URL = 'https://github.com/smartjaganrao/ai-interview-helper/releases/download/v1.1.0-beta.2/AI-Interview-Helper-v1.1.0-beta.2-portable-win-x64.zip';
