      ...
      <div className="pt-24 pb-20 max-w-3xl mx-auto px-4">
        ...
        <div className="card mb-6 text-center">
          ...
          <p className="text-slate-400 mb-6 max-w-lg mx-auto">
            Download JavihAI, sign in, then open <strong className="text-white">Menu → Mock Interview</strong>.
            Pick a role and experience level, answer 5 questions, and get an AI-scored breakdown — all inside the app.
          </p>
        ...
        <div className="card">
          ...
          <ul className="space-y-2 text-sm text-slate-400">
            <li>• Choose your target role and experience level</li>
            <li>• 5 questions, scored out of 100 with specific feedback on each answer</li>
            <li>• ~10 minutes per session — practice as many times as you like</li>
