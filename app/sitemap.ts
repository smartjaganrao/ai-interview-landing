...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [
    ...
    { url: `${base}/compare/cluely`,            lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${base}/compare/lockedin-ai`,       lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${base}/compare/parakeet-ai`,       lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
