...
const ROWS = [
  { feature: 'Free plan',                    javihai: '✅ 25 answers/day forever',        cluely: '⚠️ 5 responses/day, 100-char limit' },
      ...
      <div className="pt-28 pb-20 max-w-5xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          ...
          <div className="card text-center opacity-75">
            ...
            <div className="text-5xl font-black text-slate-300 mb-1">$149.99<span className="text-xl font-normal text-slate-500">/mo</span></div>
            <div className="text-slate-500 mb-2">≈ ₹14,250/month for the undetectable tier</div>
