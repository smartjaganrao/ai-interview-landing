      ...
      <div className="pt-12 sm:pt-16 md:pt-20 pb-20 max-w-5xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          <div className="card border-indigo-500/50 bg-indigo-500/5 text-center">
            ...
            <div className="text-[#57534E] mb-2">Power plan — unlimited answers, all round types</div>
            <div className="text-[#15803D] text-sm font-semibold">✓ Free plan available forever</div>
          </div>
          <div className="card text-center opacity-75">
            <div className="text-sm font-semibold text-[#57534E] mb-3">Interview Coder</div>
            <div className="text-5xl font-black text-[#57534E] mb-1">$299<span className="text-xl font-normal text-[#78716C]">/mo</span></div>
            <div className="text-[#78716C] mb-2">~₹28,400/month · coding rounds only</div>
            <div className="text-red-600 text-sm">✗ No meaningful free trial</div>
          </div>
        </div>
        ...
        <div className="card bg-green-500/5 border-green-500/30 text-center mb-12">
          <p className="text-2xl font-black text-[#15803D]">You save ~₹3,16,800/year switching to JavihAI</p>
          <p className="text-[#57534E] mt-2 text-sm">$299 × 12 ≈ ₹3,40,800/year (Interview Coder) vs ₹2,000 × 12 = ₹24,000/year (JavihAI Power), at ₹95/$1</p>
        </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-[rgba(26,21,18,0.1)]">
                ...
                <th className="text-center py-3 px-4 text-[#57534E] font-medium">Interview Coder</th>
              </tr>
            </thead>
            <tbody>
              {ROWS.map((row, i) => (
                <tr key={i} className={`border-b border-[rgba(26,21,18,0.08)] ${i % 2 === 0 ? 'bg-[rgba(26,21,18,0.03)]' : ''}`}>
                  ...
                  <td className="py-3 px-4 text-center text-[#57534E]">{row.ic}</td>
                </tr>
              ))}
            </tbody>
          </table>
