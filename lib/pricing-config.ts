...
export const PLANS: PlanConfig[] = [
  {
    ...
    tagline: 'Try it on your next practice round',
    cta: 'Start Free',
  },
  {
    id: 'quick_pass',
    ...
    tagline: 'For tomorrow\'s interview',
    cta: 'Buy Now',
  },
  {
    id: 'pro',
    ...
    tagline: 'For an active interview week',
    cta: 'Buy Now',
  },
  {
    id: 'power',
    ...
    tagline: 'For an ongoing job search',
...
export function migratePlanId(plan: AnyPlanId | string): PlanId {
  ...
  // of being silently rewritten to 'power' — see [[stable-release-caution]].
  if (plan === 'quick_pass' || plan === 'free' || plan === 'power' || plan === 'pro') return plan as PlanId;
