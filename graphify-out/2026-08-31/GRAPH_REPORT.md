...
## Corpus Check
- 276 files · ~202,163 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2348 nodes · 2692 edges · 290 communities (186 shown, 104 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `06b11a56`
...
Cohesion: 0.20
Nodes (14): CouponPreview, Offer, faqSchema, FeaturedCoupon, Offer, offerActiveFor(), Pricing, PricingPage() (+6 more)
...
Cohesion: 0.07
Nodes (36): DashboardContent(), detectDesktopOS(), ActivityData, CachedDashboardData, clearAllData(), clearDashboardCache(), getDayKey(), readDashboardCache() (+28 more)
...
## Knowledge Gaps
- **1474 isolated node(s):** `idea-refine.sh script`, `orgSchema`, `metadata`, `TOPIC_ANGLES`, `GeneratedPost` (+1469 more)
...
- **Why does `PlanId` connect `route.ts` to `Navbar.tsx`, `firebase-admin.ts`, `razorpay-server.ts`, `route.ts`, `email.ts`, `pricing-config.ts`, `firestore-cache.ts`, `robots.ts`, `next-env.d.ts`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `verifyIdToken()` connect `page.tsx` to `firebase-admin.ts`, `route.ts`, `email.ts`, `route.ts`, `server-cache.ts`?**
