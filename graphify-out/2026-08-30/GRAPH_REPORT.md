...
## Corpus Check
- 274 files · ~197,995 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2324 nodes · 2636 edges · 290 communities (186 shown, 104 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `00ece896`
...
Cohesion: 0.20
Nodes (16): POST(), GET(), applyCouponDiscount(), effectiveAmount(), getReferralCredits(), offerApplies(), BillingType, PLAN_RANK (+8 more)
...
Cohesion: 0.22
Nodes (14): CheckoutContent(), loadRazorpayScript(), offerActiveFor(), Pricing, RazorpayOptions, Window, migrateUserPlan(), canDowngradeTo() (+6 more)
...
## Knowledge Gaps
- **1465 isolated node(s):** `idea-refine.sh script`, `orgSchema`, `metadata`, `GeneratedPost`, `LENGTH_GUIDE` (+1460 more)
...
- **Why does `PlanId` connect `firebase` to `Navbar.tsx`, `firebase-admin.ts`, `email.ts`, `page.tsx`, `pricing-config.ts`, `page.tsx`, `firestore-cache.ts`, `next-env.d.ts`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
