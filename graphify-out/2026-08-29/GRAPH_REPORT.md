...
## Corpus Check
- 274 files · ~197,104 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2317 nodes · 2619 edges · 286 communities (182 shown, 104 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4fe5604a`
...
Cohesion: 0.09
Nodes (28): GET(), POST(), POST(), POST(), POST(), consumeHours(), couponsCache, CouponsDoc (+20 more)
...
Cohesion: 0.12
Nodes (26): DashboardContent(), detectDesktopOS(), ActivityData, CachedDashboardData, clearAllData(), clearDashboardCache(), getDayKey(), readDashboardCache() (+18 more)
...
Cohesion: 0.14
Nodes (27): faqSchema, offerActiveFor(), Pricing, PricingPage(), DurationType, getPlanBadge(), getPlanBillingLabel(), getPlanById() (+19 more)
...
Cohesion: 0.13
Nodes (22): CheckoutContent(), CouponPreview, loadRazorpayScript(), Offer, offerActiveFor(), Pricing, RazorpayOptions, Window (+14 more)
...
- **Why does `migratePlanId()` connect `next-env.d.ts` to `Navbar.tsx`, `firebase-admin.ts`, `route.ts`, `pricing-config.ts`, `page.tsx`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `PlanId` connect `page.tsx` to `Navbar.tsx`, `firebase-admin.ts`, `razorpay-server.ts`, `email.ts`, `page.tsx`, `pricing-config.ts`, `next-env.d.ts`?**
