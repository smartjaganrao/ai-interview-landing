# Graph Report - ai-interview-landing  (2026-08-22)

## Corpus Check
- 263 files · ~190,751 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2246 nodes · 2515 edges · 277 communities (176 shown, 101 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5bb1b469`
...
## Communities (277 total, 101 thin omitted)

### Community 0 - "Navbar.tsx"
Cohesion: 0.11
Nodes (27): LoginPage(), attributeCreatorIfPending(), claimReferralIfPending(), SignupContent(), CreatorData, CreatorPage(), BLANK, Education (+19 more)
...
Cohesion: 0.11
Nodes (19): clsx, firebase, next, dependencies, clsx, firebase, next, razorpay (+11 more)
...
Cohesion: 0.11
Nodes (35): faqSchema, offerActiveFor(), Pricing, PricingPage(), productSchema, migrateUserPlan(), canDowngradeTo(), canUpgradeTo() (+27 more)
...
Cohesion: 0.11
Nodes (16): CheckoutContent(), loadRazorpayScript(), Offer, offerActiveFor(), Pricing, RazorpayOptions, Window, Offer (+8 more)
...
## Knowledge Gaps
- **1426 isolated node(s):** `idea-refine.sh script`, `orgSchema`, `metadata`, `GeneratedPost`, `LENGTH_GUIDE` (+1421 more)
...
- **Why does `useAuth()` connect `Navbar.tsx` to `page.tsx`, `pricing-config.ts`, `next-env.d.ts`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `migratePlanId()` connect `pricing-config.ts` to `Navbar.tsx`, `firebase-admin.ts`, `route.ts`, `page.tsx`, `next-env.d.ts`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
