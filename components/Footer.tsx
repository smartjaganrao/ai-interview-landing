...
export default function Footer() {
  return (
    <footer className="border-t border-white/10 mt-20">
      <div className="max-w-7xl desktop:max-w-[1440px] desktop-lg:max-w-[1600px] mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          {/* Brand */}
          <div className="col-span-2">
            <div className="flex items-center gap-3 mb-4">
              <Image src="/logo.svg" alt="JavihAI" width={40} height={40} unoptimized className="h-10 w-10 object-contain" />
              <div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link href="/compare/cluely" className="text-slate-400 hover:text-white transition">vs Cluely</Link></li>
